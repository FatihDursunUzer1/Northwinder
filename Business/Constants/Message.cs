...
namespace Business.Constants
{
    ...
    {
        public static string ProductAdded = "Ürün ekleme işlemi başarıyla gerçekleştirildi";

        public static string ProductsListed = "Ürünleri listeleme işlemi başarıyla gerçekleştirildi";
